...
import { Activity, Building2, TrendingDown } from "lucide-react";
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-lg font-semibold leading-tight sm:text-xl">
                <span className="text-[#ffd60a]">See The Gap 🇦🇪</span>
              </div>
          ...
          <div className="flex flex-wrap gap-2">
            <Link
              href={developerHref}
              className="inline-flex items-center justify-center gap-2 rounded-full border border-[#2563eb]/35 bg-[#2563eb]/15 px-3 py-2 text-[11px] uppercase tracking-[0.16em] text-[#93c5fd] transition hover:bg-[#2563eb]/25"
            >
        ...
        <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap">
          <StatChip label="Deals" value={String(stats.totalDrops ?? 0)} />
          <StatChip
            label="Avg Gap"
        ...
        <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-[11px] uppercase tracking-[0.18em] text-white/50">
          ...
          <div>
            {lastUpdatedSeconds === null ? "Updated: --" : `Updated: ${lastUpdatedSeconds}s ago`}
          </div>
